...
describe Builder do
  ...
  it "responds to :new with an instance" do
    @builder.instance_of?(Builder).must_equal true
  end
  ...
  it "accepts new words (chainable)" do
    @builder.add_word('new').must_be_kind_of Builder
  end

  it "should be chainable" do
    @builder.add_word('cat').add_word('car').kind_of?(Builder)
      .must_equal true
  end
...
describe "Array-based trees" do
  ...
  it "are generated from strings" do
    Builder.add_to_tree("a").must_equal [['a',[nil]]]
  end

  it "can incorporate new strings that share a prefix" do
    a = Builder.add_to_tree("a")
    Builder.add_to_tree("aa",a).must_equal [['a', [nil, ['a', [nil]] ] ]]
  ...
  it "can extend themselves longer words" do
    ...
    Builder.add_to_tree("cats",a).must_equal expected
  end
  ...
  it "don't change if you add the same word twice" do
    ...
    Builder.add_to_tree("cart",a).must_equal expected
  end
  ...
  it "incorporate sub-words" do
    ...
    Builder.add_to_tree("car",a).must_equal expected
  end
...
describe "Abbrev::Builder abbreviations" do
  ...
  it "are extracted from trees" do
    Builder.abbrevs_of(a)['a'].must_equal 'a'
  end

  it "are built from trees" do
    Builder.abbrevs_of(carcat)['car'].must_equal 'car'
    Builder.abbrevs_of(carcat)['cat'].must_equal 'cat'
    Builder.abbrevs_of(carcart)['car'].must_equal 'car'
    Builder.abbrevs_of(carcart)['cart'].must_equal 'cart'
  end
